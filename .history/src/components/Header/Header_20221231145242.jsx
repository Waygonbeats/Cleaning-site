  ...
  return (
    <nav className="headerPozition">
      <div className="imgConteiner">
        <img className="img" src="public\static\images\logo.png"
/>      </div>
      ...
      <div className="commContainer">
        <div className="messengerImgContainer">
          <img className="messengerImg" src="public\static\images\wapplogo.png" />
          <img className="messengerImg" src="public\static\images\tglogo.png" />
        </div>
