        ...
        <div className="rounded-lg shadow-lg  bg-white w-56 m-2 ">
          ...
          <div className="p-6">
            ...
            <AnchorLink href="#makeOrder">
              <button
                type="button"
                className=" inline-block px-6 mt-8 py-2 bg-amber-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-amber-600 hover:shadow-lg focus:bg-amber-500 focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
              >
                Заказать
              </button>
            </AnchorLink>
