  ...
  return (
    <nav className="headerPozition">
      ...
      <div className="navPozition">
        <div className="novigationHeader" href="#aboutUs">О нас</div>
        <div className="novigationHeader" >Материалы</div>
        <div className="novigationHeader" href="#services">Услуги</div>
        <div className="novigationHeader" href="#form">Сделать заказ</div>
      </div>
