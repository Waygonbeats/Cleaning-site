      ...
      <div className="flex justify-center ">
        <div className="rounded-lg shadow-lg bg-white w-56 m-2">
          <a href="#!">
            <img
              ...
              src="https://avatars.mds.yandex.net/get-images-cbir/7676095/DzDOwS0ZeKGY772BbnEB9g9149/ocr"
              alt=""
            />
          </a>
          <div className="p-6">
        ...
        <div className="rounded-lg shadow-lg  bg-white w-56 m-2 ">
          <a href="#!">
            <img
              className="rounded-t-lg"
              src="https://avatars.mds.yandex.net/get-images-cbir/7735563/Y4QTVQ7BeaoP5Asc5lU6Rg9203/ocr"
              alt=""
            />
          </a>
          <div className="p-6">
        ...
        <div className="rounded-lg shadow-lg bg-white w-56 m-2">
          <a href="#!">
            <img
              className="rounded-t-lg"
              src="https://avatars.mds.yandex.net/get-images-cbir/2404916/XGpb4AvLi6puOp5spfUvtQ9235/ocr"
              alt=""
            />
          </a>
          <div className="p-6">
        ...
        <div className="rounded-lg shadow-lg bg-white w-56 m-2">
          <a href="#!">
            <img
              className="rounded-t-lg"
              src="https://avatars.mds.yandex.net/get-images-cbir/7741866/tVb330nMEWhE2q2_DqRSHg9256/ocr"
              alt=""
            />
          </a>
          <div className="p-6">
