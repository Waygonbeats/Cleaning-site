...
export const Downdrop = () => {
  ...
  return (
    <div className="dropdown w-[40%] items-center flex flex-col">
      <button
        className="text-white w-[100%] bg-amber-600 hover:bg-amber-500 focus:ring-4  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
