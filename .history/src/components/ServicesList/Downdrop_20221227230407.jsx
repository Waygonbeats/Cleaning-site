...
export const Downdrop = () => {
  ...
  return (
    <div className="dropdown">
      ...
      <div
        id="dropdown"
        className={`z-10 w-44 bg-white rounded flex justify-center divide-y divide-gray-100 shadow ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <ul className=" z-10 w-44 bg-white rounded divide-y flex justify-center divide-gray-100 shadow ">
