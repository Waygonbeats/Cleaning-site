...
export const Downdrop = () => {
  ...
  return (
    <div className="dropdown w-2xl ">
      <button
        className="text-white w-2xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
