 ...
 */}
          ...
          <div className="group inline-block">
            <button className="outline-none focus:outline-none border px-3 py-1 bg-white rounded-sm flex items-center min-w-32">
              <span className="pr-1 text-black font-semibold flex-1">Dropdown</span>
              <span>
                <svg
  ...
  transition duration-150 ease-in-out origin-top min-w-32"
            >
              ...
              <li className="rounded-sm px-3 text-black  py-1 hover:bg-gray-100">DevOps</li>
  ...
  "
                >
                  <li className="px-3 py-1 text-black hover:bg-gray-100">Javascript</li>
                  <li className="rounded-sm relative px-3 py-1 hover:bg-gray-100">
                    <button className="w-full text-left flex items-center outline-none focus:outline-none">
